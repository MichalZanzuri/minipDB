...
>#1  ❶ מספר ההזמנות לכל ספק בכל שנה לפי סטטוס:
...
>#3 ❸ ממוצע מחיר מוצר לפי קטגוריה וחודש הוספה:
...
>#5 ❺ עובדים שביצעו יותר מ־3 הזמנות בסכום כולל של מעל 1000 ש"ח: 
...
>#6 ❻ כל ההחזרות מהשנה האחרונה כולל פרטי ספק:
...
>#7  ❼ כמות ההזמנות שסופקו בזמן לעומת כמות ההזמנות שאיחרו: 
...
>#8  ❽ כמות מוצרים לפי צבע ומין, מחולקת לפי חודש הוספה:  
